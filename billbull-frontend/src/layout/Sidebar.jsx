  ...
  const menuItems = [
    ...
    },
    {
      ...
      subItems: [
        ...
        { path: "/inventory/units",           label: "Units ",                module: "inventory.units",     icon: <Scale size={14} /> },
        ...
        { path: "/inventory/barcode",         label: "Barcode Print & Design",module: "inventory.barcode",   icon: <Barcode size={14} /> },
        { path: "/inventory/reports",         label: "Reports",               module: "inventory.reports",   icon: <PieChart size={14} /> },
      ],
    },
    {
      id: "sales-group",
      ...
      subItems: [
        ...
        { path: "/sales/pro-forma",     label: "Proforma Invoice",       module: "sales.proforma", icon: <File size={14} /> },
        ...
        { path: "/sales/settings",      label: "Configure & customize", module: "sales.settings", icon: <Settings size={14} /> },
      ],
    },
    {
      id: "purchase-group",
      ...
      subItems: [
        ...
        { path: "/purchases/payment",         label: "Payments",               module: "purchases.payment",icon: <CreditCard size={14} /> },
        { path: "/purchases/templates",       label: "Print & Email Templates", module: "purchases.templates",icon: <Printer size={14} /> },
        { path: "/purchases/reports/summary", label: "Purchase Summary Report", module: "purchases.reports",icon: <PieChart size={14} /> },
      ],
    },
...

    {
      ...
      subItems: [
        ...
        { path: "/finance/expenses",        label: "Expenses",                  module: "finance.expense",  icon: <TrendingDown size={14} /> },
        ...
        { path: "/finance/reports",         label: "Reports",                   module: "finance.reports",  icon: <PieChart size={14} /> },
        { path: "/finance/config",          label: "Chart of Accounts & Config",module: "finance.config",   icon: <Settings size={14} /> },
        { path: "/finance/templates",       label: "Print & Email Templates",   module: "finance.templates",icon: <Printer size={14} /> },
      ],
    },
    {
      id: "hr-group",
