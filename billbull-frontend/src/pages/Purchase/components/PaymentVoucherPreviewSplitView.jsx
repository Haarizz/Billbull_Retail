...
import PaymentVoucherCardList from './PaymentVoucherCardList';
import PaymentVoucherPreview from './PaymentVoucherPreview';

// Payment Voucher Transaction Preview page: persistent voucher switcher +
// read-only preview. Vouchers are keyed by their numeric backend id (dbId).
export default function PaymentVoucherPreviewSplitView({
    vouchers,
    previewVoucherDbId,
    onSelectVoucher,
    listLoading,
    ...
    const selectedVoucher = vouchers?.find((v) => v.dbId === previewVoucherDbId);
    ...
    const listNode = (
        <PaymentVoucherCardList
            vouchers={vouchers}
            selectedDbId={previewVoucherDbId}
    ...
    return (
        <div className="animate-in fade-in duration-200">
            ...
            >
                ...
                Browse vouchers
                {selectedVoucher && <span className="text-slate-400 font-normal">· {selectedVoucher.id}</span>}
            </button>
            ...
            <div className="grid lg:grid-cols-[minmax(260px,300px)_1fr] xl:grid-cols-[minmax(300px,340px)_1fr] gap-4 items-start">
                ...
                <div className="min-w-0">
                    <PaymentVoucherPreview voucherId={previewVoucherDbId} {...previewProps} />
                </div>
            </div>
                ...
                <div className="lg:hidden fixed inset-0 z-50 flex">
                    ...
                    >
                        <div className="flex items-center justify-between px-3 py-2.5 border-b border-slate-200 bg-white shrink-0">
                            <span className="text-xs font-bold text-slate-700 uppercase tracking-wide">Payment Vouchers</span>
                            <button
                                type="button"
                                onClick={() => setDrawerOpen(false)}
                                aria-label="Close"
