  ...
  >
    ...
    <div className="grid grid-cols-2 gap-2 text-xs border-t border-slate-100 pt-3">
      <div>
        ...
        <span className="font-bold text-slate-700">{formatCurrencyDisplay(row.totalValue, currencyLabel)}</span>
      </div>
                ...
                .map((row) => (
                  <tr key={row.lpoNumber} className="hover:bg-slate-50 transition-colors group">
                    ...
                    <td className="px-4 py-3 text-right font-bold text-slate-900">
                      {formatCurrencyDisplay(row.totalValue, currencyLabel)}
                    </td>
                    <td className="px-4 py-3">
            ...
            <div className="flex-1 space-y-3 w-full">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                ...
                <div>
                  ...
                  <div className="font-bold text-[#F5C742] text-sm">{formatCurrencyDisplay(card.value)}</div>
                </div>
                <div>
            ...
            <div className="space-y-2 text-xs border-t border-slate-100 pt-3">
              <div className="flex justify-between">
                ...
                <span className="font-medium">
                  {formatCurrencyDisplay(calculations.subtotal, currencyLabel)}
                </span>
              </div>
              <div className="flex justify-between text-green-600">
                <span className="font-medium">Discount</span>
                <span className="font-medium">
                  -{formatCurrencyDisplay(calculations.totalDiscount, currencyLabel)}
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-slate-500">Tax</span>
                <span className="font-medium">
                  {formatCurrencyDisplay(calculations.tax, currencyLabel)}
                </span>
              </div>
              <div className="flex justify-between text-base pt-2 border-t border-slate-100 mt-2">
                ...
                <span className="font-bold text-[#F5C742]">
                  {formatCurrencyDisplay(calculations.grandTotal, currencyLabel)}
                </span>
              </div>
            </div>
          </div>
